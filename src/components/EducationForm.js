...
const EducationForm = function (props) {
  const onCancel = () => props.parentCallbackEducCancel(false);
      ...
      <form onSubmit={onSubmit}>
        <div className='form__row'>
          ...
          <input
            ...
            defaultValue={props.data === undefined ? "" : props.data.uni}
          ></input>
        </div>
          ...
          <input
            ...
            defaultValue={
              props.data === undefined
                ? ""
                : props.data.sub.slice(1, props.data.sub.length - 1)
            }
          ></input>
        </div>
